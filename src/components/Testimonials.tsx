  ...
  const testimonials = [
    {
      ...
      location: 'Mumbai',
      content: 'Takai Labs transformed our clinic\'s online presence. Patient bookings increased by 300% within 3 months. The website is beautiful and easy to manage.',
      rating: 5,
    ...
    },
    {
      ...
      role: 'Pharmacy Owner',
      location: 'Hyderabad',
      content: 'Takai Labs created a perfect solution for our online pharmacy. The prescription upload feature and delivery tracking have made our customers very happy.',
      rating: 5,
